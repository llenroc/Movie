...
namespace Infrastructure.EntityFramework
{
    public abstract class DbContextTypeMatcher<TBaseDbContext> : IDbContextTypeMatcher, ISingletonDependency
    {
        ...
        public virtual Type GetConcreteType(Type sourceDbContextType)
        {
            ...
            {
                throw new InfrastructureException("Could not find a concrete implementation of given DbContext type: " + sourceDbContextType.AssemblyQualifiedName);
            }
        ...
        private void CheckCurrentUow()
        {
            ...
            {
                throw new InfrastructureException("GetConcreteType method should be called in a UOW.");
            }
        }

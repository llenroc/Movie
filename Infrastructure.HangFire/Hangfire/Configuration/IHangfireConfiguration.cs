...
namespace Infrastructure.Hangfire.Configuration
{
    ...
    public interface IHangfireConfiguration
    {
        ...
        /// Important: This is null in <see cref="InfrastructureModule.PreInitialize"/>. You can create and set it to customize it's creation.
        /// If you don't set it, it's automatically set in <see cref="InfrastructureModule.PreInitialize"/> by Infrastructure.HangFire module with it's default constructor

...
using Infrastructure.Web.Features;
using Infrastructure.Web.Localization;
using Infrastructure.Web.MultiTenancy;
using Infrastructure.Web.Navigation;
using Infrastructure.Web.Security;
using Infrastructure.Web.Sessions;
using Infrastructure.Web.Settings;
using Infrastructure.Web.Timing;
...
namespace Infrastructure.Web.Mvc.Controllers
{
    ...
    /// to work with .
    /// </summary>
    public class ScriptsController : InfrastructureController
    {
        ...
        private static string GetTriggerScript()
        {
            ...
            script.AppendLine("    infrastructure.event.trigger('infrastructure.dynamicScriptsInitialized');");
            script.Append("})();");

...
namespace Infrastructure.Web.Mvc.Controllers.Results
{
    /// <summary>
    /// This class is used to override returning Json results from MVC controllers.
    /// </summary>
    public class InfrastructureJsonResult : JsonResult
    {
        /// <summary>
        ...
        /// Constructor.
        /// </summary>
        public InfrastructureJsonResult()
        {
        ...
        public InfrastructureJsonResult(object data): this()
        {
            Data = data;
        }

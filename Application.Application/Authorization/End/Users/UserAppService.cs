...
namespace Application.Authorization.End.Users
{
    ...
    //[InfrastructureAuthorize(PermissionNames.PagesAdministrationUsers)]
    public class UserAppService :CrudAppService<User,UserListDto,long,UserGetAllInput,CreateUserInput,UpdateUserInput> , IUserAppService
    {

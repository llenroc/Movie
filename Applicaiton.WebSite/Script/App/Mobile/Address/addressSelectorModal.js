(function () {
    ...
    appModule.controller(controllerId, ['$scope', '$uiModalInstance', 'infrastructure.services.app.addressForFront', '$sce',
        function ($scope, $uiModalInstance, addressService, $sce) {
            var vm = this;
            vm.addresses = [];

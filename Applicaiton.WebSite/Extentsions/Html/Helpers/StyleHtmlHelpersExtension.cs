...
namespace System.Web.Mvc
{
    public static class StyleHtmlHelpersExtension
    {
        ...
        public static MvcHtmlString GetActionStyles(this HtmlHelper htmlHelper,string actionName=null)
        {
            string areaName = htmlHelper.GetAreaName();
        ...
        public static MvcHtmlString GetActionStyle(this HtmlHelper htmlHelper)
        {
            string areaName = htmlHelper.GetAreaName();
            string controllerName = htmlHelper.ViewContext.RouteData.GetRequiredString("controller");

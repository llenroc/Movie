...
{
    /// <summary>
    /// Defines an authorization source to be used by <see cref="UserManager{TRole,TUser}.LoginAsync"/> method.
    /// </summary>
        ...
        where TUser : CommonFrameUser<TUser>
    {
        ...
        /// This source name is set to <see cref="User{TTenant,TUser}.AuthenticationSource"/>

...
namespace Infrastructure.Authorization.Roles
{
    ...
    /// </remarks>
    public abstract class CommonFrameRole<TUser> : RoleBase, IFullAudited<TUser> where TUser : CommonFrameUser<TUser>
    {
        /// <summary>
        ...
        /// <summary>
        /// Creates a new <see cref="Role{TTenant,TUser}"/> object.
        /// </summary>
        public CommonFrameRole()
        {
        ...
        public CommonFrameRole(int? tenantId, string displayName) : this()
        {
            TenantId = tenantId;
        ...
        /// <param name="displayName">Display name of the role</param>
        public CommonFrameRole(int? tenantId, string name, string displayName) : this(tenantId, displayName)
        {
            Name = name;
        }

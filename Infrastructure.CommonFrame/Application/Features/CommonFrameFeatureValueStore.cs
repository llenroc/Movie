...
namespace Infrastructure.Application.Features
{
    ...
    /// </summary>
    public abstract class CommonFrameFeatureValueStore<TTenant, TUser> :
        ICommonFrameFeatureValueStore,
        ...
        where TUser : CommonFrameUser<TUser>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CommonFrameFeatureValueStore{TTenant, TUser}"/> class.
        /// </summary>
        protected CommonFrameFeatureValueStore(

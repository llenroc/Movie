...
namespace Infrastructure.IdentityFramework
{
    ...
    {
        private static readonly Dictionary<string, string> IdentityLocalizations= new Dictionary<string, string>
              {
        ...
        public static string LocalizeErrors(this IdentityResult identityResult, ILocalizationManager localizationManager)
        {
            ...
            if (identityResult is IdentityResult)
            {
        ...
        {
            var localizationSource = localizationManager.GetSource(CommonFrameConsts.LocalizationSourceName);

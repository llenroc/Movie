...
namespace Infrastructure.MultiTenancy
{
    ...
    /// </summary>
    public abstract class CommonFrameTenant<TUser> : TenantBase, IFullAudited<TUser>, IPassivable where TUser : CommonFrameUser<TUser>
    {
        /// <summary>
        /// "Default".
        /// </summary>
        ...
        protected CommonFrameTenant(string tenancyName, string name) : this()
        {

...
{
    /// <summary>
    /// Base class for all ApiControllers in web applications those use Infrastructure system.
    /// </summary>
    public abstract class InfrastructureApiController : ApiController
    {
        /// <summary>
        ...
        public IUnitOfWorkManager UnitOfWorkManager
        {
            get
            {
                ...
                {
                    throw new InfrastructureException("Must set UnitOfWorkManager before use it.");
                }
        ...
        /// Constructor.
        /// </summary>
        protected InfrastructureApiController()
        {

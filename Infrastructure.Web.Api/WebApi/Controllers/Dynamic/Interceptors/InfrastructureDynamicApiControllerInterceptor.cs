...
namespace Infrastructure.WebApi.Controllers.Dynamic.Interceptors
{
    /// <summary>
    ...
    public class InfrastructureDynamicApiControllerInterceptor<T> : IInterceptor
    {
        /// <summary>
        ...
        /// <summary>
        /// Creates a new InfrastructureDynamicApiControllerInterceptor object.
        /// </summary>
        /// <param name="proxiedObject">Real object instance to call it's methods when dynamic controller's methods are called</param>
        public InfrastructureDynamicApiControllerInterceptor(T proxiedObject)
        {

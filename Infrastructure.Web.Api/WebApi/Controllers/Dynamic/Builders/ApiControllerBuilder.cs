...
using Infrastructure.WebApi.Controllers.Dynamic.Interceptors;
...
namespace Infrastructure.WebApi.Controllers.Dynamic.Builders
{
    ...
    internal class ApiControllerBuilder<T> : IApiControllerBuilder<T>
    {
        ...
        public IApiControllerActionBuilder<T> ForMethod(string methodName)
        {
            ...
            {
                throw new InfrastructureException("There is no method with name " + methodName + " in type " + typeof(T).Name);
            }
        ...
        public void Build()
        {
            var controllerInfo = new DynamicApiControllerInfo(
                ...
                typeof(InfrastructureDynamicApiControllerInterceptor<T>),
                Filters,

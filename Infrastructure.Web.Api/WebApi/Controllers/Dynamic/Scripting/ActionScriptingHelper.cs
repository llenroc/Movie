...
namespace Infrastructure.WebApi.Controllers.Dynamic.Scripting
{
    internal static class ActionScriptingHelper
    {
        ...
        public static string GenerateBody(DynamicApiActionInfo actionInfo)
        {
            ...
            {
                throw new InfrastructureException("Only one complex type allowed as argument to a web api controller action. But " + actionInfo.ActionName + " contains more than one!");
            }

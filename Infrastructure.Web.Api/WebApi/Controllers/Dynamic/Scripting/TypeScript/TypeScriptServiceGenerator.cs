    ...
    public class TypeScriptServiceGenerator : ITransientDependency
    {
        ...
        public string GetScript()
        {
            ...
            if (servicePrefix.IsNullOrEmpty())
                script.AppendLine("module infrastructure.services");//Create a new Module
            else
                script.AppendLine("module infrastructure.services." + servicePrefix);//Create a new Module
            script.AppendLine("{");

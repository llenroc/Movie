...
{
    [DontWrapResult]
    public class InfrastructureCacheController : InfrastructureApiController
    {
        private readonly ICacheManager _cacheManager;

        public InfrastructureCacheController(ICacheManager cacheManager)
        {
        ...
        [HttpPost]
        [Route("api/InfrastructureCache/ClearAll")]

...
namespace Infrastructure.Application.DTO
{
    ...
    public class NameValueDto : NameValueDto<string>
    {
        ...
        /// Creates a new <see cref="NameValueDto"/>.
        /// </summary>
        public NameValueDto(string name, string value) : base(name, value)
        {
        ...
        public NameValueDto(NameValue nameValue): this(nameValue.Name, nameValue.Value)
        {
    ...
    public class NameValueDto<T> : NameValue<T>
    {
        ...
        /// Creates a new <see cref="NameValueDto"/>.
        /// </summary>
        public NameValueDto(string name, T value): base(name, value)
        {
        ...
        /// </summary>
        /// <param name="nameValue">A <see cref="NameValue"/> object to get it's name and value</param>
        public NameValueDto(NameValue<T> nameValue) : this(nameValue.Name, nameValue.Value)
        {

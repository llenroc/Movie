...
{
    public interface ICrudAppService<TEntityDto>: ICrudAppService<TEntityDto, int> where TEntityDto : IEntityDto<int>
    {
        ...
        where TDeleteInput : IEntityDto<TPrimaryKey>
    {
        ...
        PagedResultDto<TEntityDto> GetAllOfPage(TGetAllInput input);

        ListResultDto<TEntityDto> GetAll();

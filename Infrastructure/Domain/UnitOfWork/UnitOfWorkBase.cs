...
namespace Infrastructure.Domain.UnitOfWork
{
    ...
    public abstract class UnitOfWorkBase : IUnitOfWork
    {
        ...
        /// </summary>
        public IInfrastructureSession Session { protected get; set; }
        ...
        public IDisposable SetTenantId(int? tenantId)
        {
            ...
            var mustHaveTenantEnableChange = tenantId == null? DisableFilter(DataFilters.MustHaveTenant) : EnableFilter(DataFilters.MustHaveTenant);

            var mayHaveTenantChange = SetFilterParameter(DataFilters.MayHaveTenant, DataFilters.Parameters.TenantId, tenantId);
            var mustHaveTenantChange = SetFilterParameter(DataFilters.MustHaveTenant, DataFilters.Parameters.TenantId, tenantId ?? 0);

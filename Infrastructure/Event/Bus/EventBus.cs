...
using Infrastructure.Event.Bus.Factories.Internals;
using Infrastructure.Event.Bus.Handlers;
using Infrastructure.Event.Bus.Handlers.Internals;
...
namespace Infrastructure.Event.Bus
{
    ...
    public class EventBus : IEventBus
    {
        ...
        private void TriggerHandlingException(Type eventType, object eventSource, IEventData eventData, List<Exception> exceptions)
        {
            ...
            if (eventType.IsGenericType &&eventType.GetGenericArguments().Length == 1&&typeof(IEventDataWithInheritableGenericArgument).IsAssignableFrom(eventType))
            {

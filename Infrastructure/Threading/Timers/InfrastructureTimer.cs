...
namespace Infrastructure.Threading.Timers
{
    /// <summary>
    ...
    public class InfrastructureTimer : RunnableBase, ITransientDependency
    {
        /// <summary>
        ...
        public InfrastructureTimer(int period, bool runOnStart = false)
            : this()
        {
            Period = period;
        ...
        public override void Start()
        {
            if (Period <= 0)
            {
                throw new InfrastructureException("Period should be set before starting the timer!");
            }
            base.Start();

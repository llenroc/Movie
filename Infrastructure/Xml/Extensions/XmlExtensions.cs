...
namespace Infrastructure.Xml.Extensions
{
    /// <summary>
    ...
    public static class XmlNodeExtensions
    {
        ...
        public static string GetAttributeValueOrNull(this XmlNode node, string attributeName)
        {
            ...
            return node.Attributes.Cast<XmlAttribute>().Where(attr => attr.Name == attributeName).Select(attr => attr.Value).FirstOrDefault();
        }
    }
}

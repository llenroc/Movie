...
namespace Infrastructure.Authorization
{
    ...
    public class SimplePermissionDependency : IPermissionDependency
    {
        ...
        public SimplePermissionDependency(bool requiresAll, params string[] features): this(features)
        {
        ...
        {
            return context.User != null? context.PermissionChecker.IsGrantedAsync(context.User, RequiresAll, Permissions) : context.PermissionChecker.IsGrantedAsync(RequiresAll, Permissions);
        }
    }
}

...
namespace Infrastructure.Authorization
{
    ...
    /// This class can be used in database migrations or in unit tests where  is not initialized.
    /// </summary>
    public static class PermissionFinder
    {
        /// <summary>
        /// Collects and gets all permissions in given providers.
        /// This method can be used to get permissions in database migrations or in unit tests where  is not initialized.

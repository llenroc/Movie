...
namespace Infrastructure.Authorization
{
    ...
    internal static class AuthorizationInterceptorRegistrar
    {
        ...
        {
            if (SelfOrMethodsDefinesAttribute<InfrastructureAuthorizeAttribute>(type))
            {
                return true;
            }
        ...
        private static bool SelfOrMethodsDefinesAttribute<TAttr>(Type type)
        {
            ...
            return type.GetMethods(BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic).Any(m => m.IsDefined(typeof(TAttr), true));
        }
    }
}

...
namespace Infrastructure.Authorization
{
    ...
    public class InfrastructureAuthorizeAttribute : Attribute, IInfrastructureAuthorizeAttribute
    {
        /// <summary>
        ...
        /// <summary>
        /// Creates a new instance of <see cref="InfrastructureAuthorizeAttribute"/> class.
        /// </summary>
        /// <param name="permissions">A list of permissions to authorize</param>
        public InfrastructureAuthorizeAttribute(params string[] permissions)
        {

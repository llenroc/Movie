...
namespace Infrastructure.Runtime.Validation.Interception
{
    ...
    public class MethodInvocationValidator : ITransientDependency
    {
        ...
        private void CheckInitialized()
        {
            if (Method == null)
            {
                throw new Exception("This object has not been initialized. Call Initialize method first.");
            }
        }
        ...
        protected virtual void ValidateObjectRecursively(object validatingObject)
        {
            ...
            //Custom validations
            (validatingObject as ICustomValidate)?.AddValidationErrors(new CustomValidationContext(ValidationErrors,_iocResolver)
            );

...
namespace Infrastructure.Runtime.Caching.Memory
{
    ...
    /// </summary>
    public class MemoryCacheBase : CacheBase
    {
        ...
        public MemoryCacheBase(string name) : base(name)
        {
        ...
        public override void Set(string key, object value, TimeSpan? slidingExpireTime = null, TimeSpan? absoluteExpireTime = null)
        {
            if (value == null)
            {
                throw new InfrastructureException("Can not insert null values to the cache!");
            }

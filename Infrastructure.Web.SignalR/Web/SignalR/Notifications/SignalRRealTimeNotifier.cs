...
using Infrastructure.Web.SignalR.Hubs;
using Castle.Core.Logging;
using Microsoft.AspNet.SignalR;

namespace Infrastructure.Web.SignalR.Notifications
{
    /// <summary>
    ...
    public class SignalRRealTimeNotifier : IRealTimeNotifier, ITransientDependency
    {
        ...
        private static IHubContext CommonHub
        {
            get
            {
                return GlobalHost.ConnectionManager.GetHubContext<InfrastructureCommonHub>();
            }
        }

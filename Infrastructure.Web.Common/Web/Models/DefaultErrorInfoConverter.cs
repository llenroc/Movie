...
namespace Infrastructure.Web.Models
{
    ...
    {
        private readonly IWebCommonModuleConfiguration _configuration;
        ...
        public DefaultErrorInfoConverter(
            IWebCommonModuleConfiguration configuration,
        ...
        private ErrorInfo CreateErrorInfoWithoutCode(Exception exception)
        {
            ...
            if (exception is Infrastructure.Authorization.AuthorizationException)
            {
                var authorizationException = exception as Infrastructure.Authorization.AuthorizationException;
        ...
        private string L(string name)
        {
            try
            {
                return _localizationManager.GetString(WebConsts.LocalizaionSourceName, name);
            }
            catch (Exception)
            {
                return name;

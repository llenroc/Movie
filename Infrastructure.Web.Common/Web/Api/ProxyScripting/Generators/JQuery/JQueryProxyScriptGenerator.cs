...
namespace Infrastructure.Web.Api.ProxyScripting.Generators.JQuery
{
    public class JQueryProxyScriptGenerator : IProxyScriptGenerator, ITransientDependency
    {
        ...
        public string CreateScript(ApplicationApiDescriptionModel model)
        {
            ...
            script.AppendLine("/* This file is automatically generated by Infrastructure framework to use MVC Controllers from javascript. */");
            script.AppendLine();
            script.AppendLine("var infrastructure = infrastructure || {};");
            script.AppendLine("infrastructure.services = infrastructure.services || {};");
        ...
        private static void AddControllerScript(StringBuilder script, ModuleApiDescriptionModel module, ControllerApiDescriptionModel controller)
        {
            ...
            script.AppendLine($"    infrastructure.services.{module.Name.ToCamelCase()}.{controller.Name.ToCamelCase()} = infrastructure.services.{module.Name.ToCamelCase()}.{controller.Name.ToCamelCase()} || {{}};");
        ...
        private static void AddActionScript(StringBuilder script, ModuleApiDescriptionModel module, ControllerApiDescriptionModel controller, ActionApiDescriptionModel action)
        {
            ...
            script.AppendLine($"    infrastructure.services.{module.Name.ToCamelCase()}.{controller.Name.ToCamelCase()}.{action.Name.ToCamelCase()} = function({parameterList}) {{");
            script.AppendLine("      return infrastructure.ajax($.extend(true, {");
        ...
        private static void AddAjaxCallParameters(StringBuilder script, ControllerApiDescriptionModel controller, ActionApiDescriptionModel action)
        {
            ...
            script.AppendLine("        url: infrastructure.appPath + '" + ProxyScriptingHelper.GenerateUrlWithParameters(action) + "',");
